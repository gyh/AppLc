...
import static com.yangyi.guo.develop.lcrlibrary.exception.core.RecoveryActivity.RECOVERY_MODE_ACTIVE;
...
public class RecoveryService extends Service{
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        }else if(mode == Recovery.SilentMode.RECOVER_TOP_ACTVITY){
